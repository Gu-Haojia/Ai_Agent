...
def build_daily_question() -> str:
    ...
    return (
        ...
        "1. 用一段自然的话介绍今天的日期、星期和东京时间。如果今天是中国或日本的传统节日或法定假日，自然地带出节日信息。查询接下来3天内中国和日本的法定假日或传统节日；如有，用自然的方式提醒具体日期和节日，不要在正文中说明查询范围。没有相关节日时直接略过，不要输出否定说明。不要输出国际日或世界纪念日。\n"
...
def build_nightly_question() -> str:
    ...
    return (
        ...
        "1. 用一段自然的话介绍现在的东京时间、明天的日期和星期。如果明天是中国或日本的传统节日或法定假日，自然地带出节日信息。查询从明天起3天内中国和日本的法定假日或传统节日；如有，用自然的方式提醒具体日期和节日，不要在正文中说明查询范围。没有相关节日时直接略过，不要输出否定说明。不要输出国际日或世界纪念日。\n"
