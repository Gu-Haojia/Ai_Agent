    ...
    def _build_graph(self):
        ...
        def chatbot(state: State):
            ...
            try:
                ...
                general_msg = "你是一个高性能Agent，在做出最后的回复之前，你会尽可能满足以下的规则：你的客户端无法渲染markdown和latex，因此在输出最终内容前你会删除markdown和latex格式，特别是删除加粗：**、__、$$等符号，你会将它们转换为自然语言格式输出。你的输出必须符合群聊环境下的口语化表达习惯，你不会主动使用列表分点输出"
