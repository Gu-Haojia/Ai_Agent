...
<meta charset="utf-8">
<style>
*{box-sizing:border-box}html,body{margin:0;width:1024px;height:634px;background:#fff;color:#202124;font-family:"Noto Sans CJK SC",sans-serif}body{overflow:hidden}#token-usage-chart{display:grid;grid-template-rows:auto auto auto 250px auto;width:1024px;height:634px;padding:22px 24px 16px;background:#fff}.header{display:flex;align-items:flex-start;justify-content:space-between}.title{font-size:20px;font-weight:500;letter-spacing:-.02em;margin:0 0 5px}.subtitle,.period,.metric-label,.metric-detail,.legend,.panel-list{color:#7b7f85}.subtitle,.period{font-size:12px;margin:0}.period{padding-top:4px;font-variant-numeric:tabular-nums}.metrics{display:grid;grid-template-columns:repeat(4,1fr);margin:17px 0 12px}.metric{border-left:1px solid #e4e6e8;padding:0 16px}.metric:first-child{border-left:0;padding-left:0}.metric-label{display:block;font-size:11px;letter-spacing:.06em;margin-bottom:3px}.metric-value{display:block;font-size:20px;font-weight:500;font-variant-numeric:tabular-nums}.metric-detail{font-size:11px}.legend{display:flex;flex-wrap:wrap;gap:7px 20px;min-height:23px;font-size:12px}.legend-item{display:inline-flex;align-items:center;gap:7px}.swatch{display:inline-block;width:16px;height:3px}.trend{width:100%;height:250px}.trend svg{display:block;width:100%;height:100%}.chart-frame{fill:transparent;stroke:#e4e6e8}.grid line{stroke:#e4e6e8;stroke-opacity:.65}.grid path,.axis path{display:none}.axis line{stroke:#e4e6e8}.axis text{fill:#7b7f85;font-size:12px}.axis-title{fill:#202124;font-size:12px;font-weight:500}.bottom{display:grid;grid-template-columns:1fr 1fr;gap:28px;border-top:1px solid #e4e6e8;margin-top:13px;padding-top:13px}.pie-panel{display:grid;grid-template-columns:160px 1fr;align-items:center}.pie{width:160px;height:142px}.panel-title{font-size:14px;font-weight:500;margin:0 0 10px}.panel-list{display:grid;gap:7px;font-size:12px}.panel-row{display:grid;grid-template-columns:10px minmax(0,1fr) 52px 42px;gap:7px;align-items:center}.dot{width:8px;height:8px}.token-value{color:#9aa0a6;text-align:right;font-variant-numeric:tabular-nums}.value{color:#202124;font-weight:500;text-align:right;font-variant-numeric:tabular-nums}
</style>
</head>
<body>
